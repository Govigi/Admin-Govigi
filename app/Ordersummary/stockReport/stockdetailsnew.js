...
import StockTable from "@/components/StockReport/StockTable"
import { useEffect, useState } from "react"
import { OrderSummaryUrl, ProductManagementUrl } from "@/app/API/endpoints";
import StatCard from "@/components/statcard";
import { ShoppingBagIcon, Squares2X2Icon, ArrowDownTrayIcon, ArrowUpTrayIcon, PlusCircleIcon } from "@heroicons/react/24/outline";
...
export default function StockDetails() {
    ...
    return (
        <>
            <div className="p-6">
                <h1 className="text-2xl font-semibold text-gray-800 mb-6">Products Dashboard</h1>
                ...
                <div className="mt-8">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex flex-row gap-4">
                            ...
                            <div>
                                <button
                                    className="border border-gray-300 text-black p-2 text-sm rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400 flex items-center cursor-pointer">
