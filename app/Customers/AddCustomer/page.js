...
import { CustomerManagementUrl, CustomerTypesUrl, StatesAndCitiesUrl } from "../../API/endpoints"; 
...
export default function AddCustomer() {
    ...
    const handleStateChange = (e) => {
        ...
        const stateObj = states.find(s => (s.iso2 || s.code || s.id) == value) || states.find(s => s.name == value) || null;
    ...
    const fetchCities = async (stateIso2) => {
        try {
