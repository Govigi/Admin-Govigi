    ...
    <>
      <div
        className={`fixed inset-0 z-40 transition-all duration-300 ${
          isOpen ? "bg-black/30 visible opacity-100" : "invisible opacity-0"
        }`}
        onClick={closeSidePanel}
      ></div>
      <div
        aria-hidden={!isOpen}
        className={`p-2 fixed inset-y-0 right-0 z-50 transform transition-transform duration-300 ease-in-out ${
