...
import { ArrowLeftIcon, ShoppingBagIcon, UserPlusIcon,ArrowUpTrayIcon,XMarkIcon } from "@heroicons/react/24/outline";
import { useRouter } from "next/navigation";
import { useState } from "react";
import { OrderSummaryUrl, ProductManagementUrl } from "../../API/endpoints";
                ...
                <div className="space-y-8">
                    <section>
                        ...
                        <div
                            ...
                            className={`relative flex flex-col items-center justify-center w-full max-w-md p-8 rounded-xl border-2 border-dashed transition-all duration-300 ${image
