"use client";
import { CustomerDashboardUrl } from "../API/endpoints";
import StatCard from "../../components/statcard";
import { ArrowDownTrayIcon, ArrowUpTrayIcon, FolderArrowDownIcon, PlusCircleIcon, UserGroupIcon } from "@heroicons/react/24/outline";
import { ShoppingBagIcon } from "@heroicons/react/24/outline";
import CustomersTable from "../../components/customers-dashboard/customers-table";
...
export default function CustomersDashboard() {
  ...
  return (
    <>
      <div className="p-6">
        <h1 className="text-2xl font-semibold text-gray-800 mb-6">Customers Dashboard</h1>
