...
import { CategoryManagementUrl } from "../API/endpoints";
import { Square2StackIcon, Square3Stack3DIcon, Squares2X2Icon, SquaresPlusIcon } from "@heroicons/react/24/outline";
...
export default function CategoriesPage() {
    ...
    const fetchCatStats = async () => {
        try {
            const response = await fetch(CategoryManagementUrl.getAllCategoriesStats, {
                method: "GET",
                headers: {
    ...
    return (
        ...
        <div className="p-6">        
        <h1 className="text-2xl font-semibold text-gray-800 mb-6">Categories Dashboard</h1>
